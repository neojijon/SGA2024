...
#include "ThirdPersonCameraModifier.h"

void UThirdPersonCameraModifier::ModifyCamera(float DeltaTime, FVector ViewLocation, FRotator ViewRotation, float FOV,
...
void UThirdPersonCameraModifier::ModifyPostProcess(float deltaTime, float& postProcessBlendWeight,
